package com.bluetoothlamp.tiny.view.wheelview;
...
//            position = divided + offset + 1;
    ...
    public void setBackgroundDrawable(Drawable background)
    {
        ...
        background = new Drawable()
        {
            ...
            {
                canvas.drawLine(0, obtainSelectedAreaBorder()[0], viewWidth * 5, obtainSelectedAreaBorder()[0], paint);
                canvas.drawLine(0, obtainSelectedAreaBorder()[1], viewWidth * 5, obtainSelectedAreaBorder()[1], paint);
            }
