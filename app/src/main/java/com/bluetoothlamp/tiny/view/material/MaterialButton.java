package com.bluetoothlamp.tiny.view.material;
...
public class MaterialButton extends Button implements Attributes.AttributeChangeListener
{
    ...
    private void init(AttributeSet attrs, int defStyle)
    {
        ...
        if (attributes.isMaterial())
        {
            ...
            pressedBack.getPaint().setColor(attributes.getColor(2));
            if (bottom != 0) pressedBack.setPadding(0, 0, 0, bottom);
        ...
        // 设置最后一个按钮文字的颜色
        else if (attributes.getTextAppearance() == 0) setTextColor(Color.parseColor("#ff33b5e5"));
    ...
    private void startMoveRoundAnimator()
    {
        ...
        //AnimatorSet
        AnimatorSet set = new AnimatorSet();
/*        Log.v("aPaintX", "aPaintX: " + aPaintX);
        Log.v("aPaintY", "aPaintY: " + aPaintY);
        Log.v("aRadius", "aRadius: " + aRadius);
        Log.v("aBackground", "aBackground" + aBackground);*/
